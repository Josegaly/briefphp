...
<head>
    ...
    <title>Inscription | Système de Gestion des Utilisateurs</title>
    <meta name="description" content="Système de Gestion des Utilisateurs - Page d’Inscription">
      ...
      <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav>
          <ul class="flex space-x-6">
            ...
            <li><a href="/register" class="text-blue-600 hover:text-blue-800 font-medium">Inscription</a></li>
      ...
      <div class="bg-white rounded-lg shadow-soft w-full max-w-md p-8 border border-gray-200">
        ...
        <form id="registerForm" action="/register" method="POST" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <input 
              ...
              name="username" 
              required 
              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
          ...
          <div class="space-y-2">
            ...
            >
            <p class="text-xs text-gray-500">Le mot de passe doit comporter au moins 8 caractères</p>
          </div>
          ...
          <div>
            <button 
              type="submit" 
              class="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md彡 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              S’inscrire
            </button>
          </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            Déjà un compte ? 
            <a href="/login" class="text-blue-500 hover:text-blue-600 font-medium">Connexion</a>
          </p>
        </div>
      </div>
    </main>
